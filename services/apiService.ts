...
export const api = {
  ...
  users: {
    ...
    enrollWithPassword: (userId: string, courseId: string, password: string) => request<User>(`/api/users/${userId}/enroll-with-password/${courseId}`, { method: 'POST', body: JSON.stringify({ password }) }),
