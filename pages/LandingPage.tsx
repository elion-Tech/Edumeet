                ...
                {[1, 2, 3].map((i) => (
                   <div key={i} className="group bg-white/60 backdrop-blur-md border border-white/60 rounded-[32px] p-4 hover:bg-white transition-all hover:shadow-xl hover:shadow-slate-200/50 cursor-pointer">
                      <div className="aspect-[4/3] bg-slate-200 rounded-[24px] mb-6 overflow-hidden relative">
                         <img src={`https://images.unsplash.com/photo-${i === 1 ? '1573164713714-d95e436ab8d6' : i === 2 ? '1556761175-5973dc0f32e7' : '1522071820081-009f0129c71c'}?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80`} className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700" alt="Course thumbnail"/>
